...
export default function LandingPage() {
  return (
    <div className="bg-gray-950 flex flex-col items-center w-[100%] h-[100%] font-tech">
      ...
      <div
        id="home"
        className="w-[100%] h-[100vh] flex xl:flex-row flex-col justify-center xl:gap-8 gap-4 items-center"
      >
        <img className="lx:relative absolute top-[25%] rounded-full h-64 w-64" src={MeImage} alt="logo" />
